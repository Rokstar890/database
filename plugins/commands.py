...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/Netflixvilla_india')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/netflixvillaindia1"),
            ],
            [
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🔥 Join Updates Channel 🔥", url='https://t.me/Netflixvilla_india'
                )
            ]
        ]
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('MAIN CHANNEL', url='https://t.me/Netflixvilla_india')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
